...
For any finer touch-ups, you can press 't' to enter touch up mode and any of
the keys below and draw lines on the areas you want. Then again press 'n' for
updating the output.
...
class App():
    ...
    touch_mode = False      # Touch up mode
    ...
    def run(self):
        ...
        while(1):
            ...
            if k == 27:         # esc to exit
                ...
                print('Touch up mode toggle: '+str(self.touch_mode))
